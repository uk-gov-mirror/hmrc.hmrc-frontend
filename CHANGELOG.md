...
- Added containerClasses param to Internal header
...
- Added a png of the govuk crest upscaled to 200% under `src/assets/images`

## [6.83.0] - 2025-08-15

### Changed

- Added a png of the govuk crest under `src/assets/images`
...
- Suppresses sass deprecation warnings, new ADR and MAINTAINERS documentation around this
- Bumps gulp-sass
...
- patch some problems with accessible-autocomplete, removes need for users to separately load polyfill from adam liptrot
